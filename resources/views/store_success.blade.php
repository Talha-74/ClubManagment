        ...
        <div class="animation-container">
            ...
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 123 94.09">
                <defs>
                    ...
                    <mask id="squiggle-mask" maskunits="userSpaceOnUse" maskcontentunits="userSpaceOnUse">
                        <path id="squiggle-mask-path" class="cls-5 mask"
                    ...
                    <mask id="left-line-mask" maskunits="userSpaceOnUse" maskcontentunits="userSpaceOnUse">
                        <path id="left-line-mask-path" class="cls-6 mask" d="M25.78,62.5s18.38,14.73,15.9,30.91"
                            transform="translate(-2.7 -2.61)" />
                    </mask>

                    <mask id="right-line-mask" maskunits="userSpaceOnUse" maskcontentunits="userSpaceOnUse">
                        <path id="right-line-mask-path" class="cls-6 mask" d="M95.12,64.5S78.32,73.83,76.8,94.2"
                            transform="translate(-2.7 -2.61)" />
                    </mask>
                </defs>
                <path id="blue-star" class="cls-1"
                    ...
                    transform="translate(-2.7 -2.61)" />
                <path id="yellow-star" class="cls-2"
                    ...
                    transform="translate(-2.7 -2.61)" />
                <path id="yellow-burst" class="cls-2"
                ...
                <path id="red-burst" class="cls-3"
                    ...
                    transform="translate(-2.7 -2.61)" />
                <path id="mint-burst" class="cls-4"
